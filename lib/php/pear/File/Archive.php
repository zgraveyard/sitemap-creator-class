...
class File_Archive
{
                  ...
                  $uncompression = 0, $directoryDepth = -1)
    {
        ...
        require_once 'Archive/Reader.php';
        ...
        if ((empty($URL) || is_dir($URL)) && $source === null) {
            ...
            if (!empty($realSymbolic)) {
                ...
                require_once "Archive/Reader/ChangeName/AddDirectory.php";
        ...
        //Else, we will have to build a complex reader
            ...
            if ($std != $realSymbolic) {
                require_once "Archive/Reader/ChangeName/Directory.php";
    ...
    function cache(&$toConvert)
    {
        ...
        require_once 'Archive/Reader/Cache.php';
...
/*        case 'cab':
            require_once 'Archive/Reader/Cab.php';
